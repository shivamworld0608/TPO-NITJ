...
// import AlumniLogin from "./alogin.jsx";
...
const Header = () => {
  ...
  return (
    <>
                ...
                <div className="flex w-full flex-row justify-between px-4">
                  ...
                  >
                    <div id="Academics" className="p-1.5 font-medium uppercase">
                      <a href="/internships"></a>Internships
                    </div>
                  </div>
                  <div
                    id="menu-3"
      ...
      >
        <span aria-hidden="true" className="sr-only sm:w-1/2">
          ONLY for tailwindCSS
        </span>
        <form
          id="search_form"
          className="sticky h-10 top-0 w-full z-[52]"
          ...
          <div className="flex px-2 sm:px-28">
            ...
            <div className="relative w-full">
              <input
                type="text"
                id="searchbar"
                onKeyUp="search_resources()"
                onSubmit="showSearchPage(event)"
                ...
                placeholder="Search Resources, Navbar links..."
                required={true}
              />
              <button
                type="button"
        ...
        >
          <div
            id="Big_alphabets"
            className="min-h-screen min-w-full text-4xl font-bold px-2 sm:px-28"
          ></div>
          <div
            id="noresult"
            className="absolute hidden min-w-full top-44 text-2xl font-bold"
          >
