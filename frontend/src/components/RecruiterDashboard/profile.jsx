    ...
    <div className="flex flex-wrap">
      ...
      <div className="w-full md:w-1/2 space-y-6">
        ...
        <div className="flex items-center">
          ...
          <p className="font-italic tracking-tight">Company: {formData.year}</p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 space-y-6">
        <div className="flex items-center">
          ...
          <p className="font-italic tracking-tight">Designation: {formData.gender}</p>
        </div>
        <div className="flex items-center">
          <div className="text-white mx-4 bg-custom-blue h-10 w-10 p-2 justify-center items-center rounded-full">
            <CheckCircle2 />
          </div>
          <p className="font-italic tracking-tight">Alternate Mobile: {formData.cgpa}</p>
        </div>
        <div className="flex items-center">
          <div className="text-white mx-4 bg-custom-blue h-10 w-10 p-2 justify-center items-center rounded-full">
            <CheckCircle2 />
