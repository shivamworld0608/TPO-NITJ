    ...
    <div className="max-w-6xl mx-auto p-8 bg-white rounded-2xl shadow-2xl mt-10 transform transition-all duration-300 hover:shadow-3xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Company Name<span className='text-red-500'> *</span></label>
            <input
              required
              type="text"
              name="company_name"
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Job Role<span className='text-red-500'> *</span></label>
            <input
              required
              type="text"
              name="job_role"
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Application Deadline<span className='text-red-500'> *</span></label>
            <input
              required
              type="date"
              name="deadline"
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Job Type<span className='text-red-500'> *</span></label>
            <Select
              required
          ...
          <div>
            <label className="block text-gray-700 font-semibold mb-2">Job Category<span className='text-red-500'> *</span></label>
            <Select
              required
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              <label className="block text-gray-700 font-semibold mb-2">Departments Allowed<span className='text-red-500'> *</span></label>
              <Select
                required
            ...
            <div>
              <label className="block text-gray-700 font-semibold mb-2">Gender Allowed<span className='text-red-500'> *</span></label>
              <select
                required
                name="gender_allowed"
            ...
            <div>
              <label className="block text-gray-700 font-semibold mb-2">Course Allowed<span className='text-red-500'> *</span></label>
              <select
                required
                name="course_allowed"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Batch Allowed<span className='text-red-500'> *</span></label>
                <select
                  required
                  name="eligible_batch"
              ...
              <div className="flex items-center">
                <label className="block text-gray-700 font-semibold mb-2 mr-2">Active Backlogs Allowed</label>
                <input
                  type="checkbox"
          ...
          <div className="mt-8">
            <h2 className="text-2xl font-bold text-blue-600 mb-6">
              Hiring Workflow <span className="text-red-500 text-sm">(You can reorder rounds by dragging. And please ensure your hiringflow rounds is in below sequence as it can not be change later)</span>
            </h2>
            ...
            <div>
              ...
              <Select
                ...
                value={workflowStepOptions.find(option => option.value === workflowStep.step_type)}
                className="rounded-xl"
              />
            </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-blue-600">
                      Round {index + 1}: {workflowStepOptions.find(opt => opt.value === step.step_type)?.label}
                    </h3>
