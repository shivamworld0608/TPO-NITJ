...
// Component for Recruiter
const RecruiterApplicationForm = ({ formTemplateId }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-10">
      <h1 className="text-2xl font-bold mb-6 text-center">Student Applied( Visible to Recruiter)</h1>
      <button
