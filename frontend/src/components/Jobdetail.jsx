            ...
            {jobDetails?.Hiring_Workflow?.map((step, index) => (
                <div key={index} className="relative flex items-start space-x-6 group">
                    ...
                    <div className="relative flex flex-col items-center">
                        <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg group-hover:bg-blue-500 transition-colors">
                            <span className="text-sm">{index + 1}</span>
                        </div>
                        {/* Vertical Line */}
                        {index !== jobDetails.Hiring_Workflow.length  && (
                            <div className="absolute top-7 left-1/2 transform -translate-x-1/2 w-1 bg-blue-600 group-hover:bg-blue-500 transition-all" style={{
